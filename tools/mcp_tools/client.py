...
class MCPClient:
    ...
    def __init__(self,
                 server_source: Union[str, List[str], FastMCP, Dict[str, Any]], # type: ignore
    ...
    def _prepare_server_source(self, server_source: Union[str, List[str], FastMCP, Dict[str, Any]]): # type: ignore
