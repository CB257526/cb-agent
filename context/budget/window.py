...
五级优先级:
1. env override (CB_AGENT_MAX_CONTEXT_TOKENS)
2. model id 含 "[1m]" / "[1M]" / "1m" 后缀 -> 1_000_000
3. ConstantLLM.llm_dict[model]['max_tokens'] (现有字段)
4. betas 含 "context-1m-2025-08-07" -> 1_000_000
5. DEFAULT_CONTEXT_WINDOW = 200_000
"""
